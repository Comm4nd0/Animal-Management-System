# ─── S3 Bucket: Flutter Web Frontend ──────────────────────────
...
resource "aws_cloudfront_origin_access_identity" "frontend" {
  comment = "${var.project_name} frontend access"
}
...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  # Flutter SPA: serve index.html for all routes
  ...
  # Cheapest price class: US, Canada, Europe only
